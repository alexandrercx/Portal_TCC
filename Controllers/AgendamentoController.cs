...
namespace ServicoAssociadoWeb.Controllers
{
   public class AgendamentoController : Controller
   {
      ...
      public AgendamentoController(IConfiguration configuration, IAgendamentoApi agendamentoApi, IGatewayApi gatewayApi)
      {
         _IConfiguration = configuration;
         //_AgendamentoApi = agendamentoApi;
      ...
      public ActionResult Index()
      {
         ...
         {
            var list = _IGatewayApi.ApiAgendamentoGet(
      ...
      public ActionResult Details(int id)
      {
         if (User.Identity.IsAuthenticated)
         {
            var item = _IGatewayApi.ApiAgendamentoIdGet(
               token: _IConfiguration.GetSection("Settings:ApiAgendamento:ApiKey").Value,
               id: id);
            return View(item);
         }
      ...
      public ActionResult Create(IFormCollection collection)
      {
         try
         {
            ...
            if (ModelState.IsValid)
            {
               ...
               var response = _IGatewayApi.ApiAgendamentoPost(
                   token: _IConfiguration.GetSection("Settings:ApiAgendamento:ApiKey").Value,
                   body: body
               );
