...
namespace ServicoAssociadoWeb.Controllers
{
    public class AssociadoController : Controller
    {
        ...
        public AssociadoController(IAssociadoApi associadoApi, IConfiguration configuration)
        {
        ...
        public IActionResult Register(AssociadoViewModel model)
        {
            try
            {
                ...
                var associado = _IAssociadoApi.ApiAssociadoGet(model.Email);
                ...
                else
                {
                    ...
                    var response = _IAssociadoApi.ApiAssociadoPost(request);
