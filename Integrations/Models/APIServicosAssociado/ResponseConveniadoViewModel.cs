...
namespace ServicoAssociadoWeb.Integrations.Models.APIServicosAssociado {
  ...
  public class ResponseConveniadoViewModel {
    ...
    /// <summary>
    /// Gets or Sets DocProfissional
    /// </summary>
    [DataMember(Name="docProfissional", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "docProfissional")]
    ...
    public override string ToString()  {
      ...
      sb.Append("class ResponseConveniadoViewModel {\n");
      sb.Append("  Id: ").Append(Id).Append("\n");
      sb.Append("  Documento: ").Append(Documento).Append("\n");
      sb.Append("  Nome: ").Append(Nome).Append("\n");
      sb.Append("  DocProfissional: ").Append(DocProfissional).Append("\n");
